<!-- app/views/dashboard/incidents.blade.php -->
                            ...
                            <tbody>
                                @foreach ($incidents as $incident)
                                    <tr>
                                        <!-- Reference -->
                                        <td class="table-text">
                                            <div>{{ 'Incident No:' }} {{ $incident->reference }}</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- Incident Type -->
                                        <td class="table-text">
                                            <?php
                                                $type = \App\Models\IncidentType::find($incident->type_id)
                                            ?>
                                            <div>{{ 'Incident Type:' }} {{ $type->type }}</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- Assignee Name -->
                                        <td class="table-text">
                                            <?php
                                            $user = \App\Models\User::find($incident->user_id);
