<!-- app/views/dashboard/complaints.blade.php -->
...
@section('content')
    ...
    <!-- Current Complaint Management report -->
                            ...
                            <!-- Table Body -->
                                ...
                                @foreach ($complaints as $complaint)
                                    <tr>
                                        <!-- Reference -->
                                        <td class="table-text">
                                            <div>{{ 'Complaint No:' }} {{ $complaint->reference }}</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- Incident Type -->
                                        <td class="table-text">
                                            <?php
                                            $type = \App\Models\Complaint::find($complaint->complaints_id)
                                            ?>
                                            <div>{{ 'Complaint Type:' }} {{ $type->type }}</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- Assignee Name -->
