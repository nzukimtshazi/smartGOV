...
<html lang="en">
    ...
    <!-- NAVIGATION WITH LOGO AND USER PROFILE -->
        <!-- ============================================================= -->
        {!! Form::model(new App\Models\GenericCall, ['route' => ['storeCall']]) !!}
        ...
        <div class="wrapper">
            ...
            <div class="main p-3">
                <div class="navbar" style="background-color: yellow; margin-left:-15px; margin-top:-15px;">
                    ...
                    <div class="row1" style=" background-color: yellow; width:100%;">
                        <div class="column1" style="float:left; width:40%;">
                            <span class="name" style="color:black; "><strong>GENERIC CALL</strong></span>
                        </div>
                ...
                <fieldset class="fieldset" style="display:inline;">
                    ...
                    <div class="user-details" style="display:inline;">
                        <div class="input-box4">
                            <span class="details">Type of Call:</span>
                ...
                <fieldset class="fieldset" style="display:inline;">
                    ...
                    <div class="user-details" style="display:inline;">
                        <div class="input-box1">
                            <span class="details">Brief Description of Your Issue:</span>
                            <textarea id="w3review" name="complaint_info" required></textarea>
                        </div>
                    </div>
                </fieldset>
