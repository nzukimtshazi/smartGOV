    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <!-- ------------------------------------------------------------------------------------------ -->
                <a style="margin-top: -25px;" href="Applications2.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    ></i>Applications</a>
                ...
                <div class="row my-5">
                        ...
                        if ($sql_result) {	
                            ...
                            if ($result5-> num_rows > 0){	
                                while($row5 = $result5-> fetch_assoc()){
                                    $comment1 = $row5['comments'];
                                    $comment2 = $row5['comments2'];
                                }
                            }
                            ...
                            Our team reviewed your application and we’d like to inform you that your application was successful.
                            <br><br>Comments made by our team:-<br>Stage 1: $comment1<br>Stage 2: $comment2<br>Final Stage: $comments
                    ...
                    if(isset($_POST['btn_partial'])){
                        ...
                        if ($sql_result) {	
                            ...
                            $_SESSION['email_body'] = "Dear $name<br><br>Thank you for taking your time to apply for research funding. 
                            Our team reviewed your application and we’d like to inform you that your application was successful.
                            However some parts of your application were approved, and some parts were rejected.
                            <br><br>Comments made by our team:-<br>Stage 1: $comment1<br>Stage 2: $comment2<br>Final Stage: $comments
                            <br><br>Regards,<br>Research Funding Team";
                            $_SESSION['location'] = "<script>location.href = 'thankyou.php?'</script>";
                            // echo"<script>location.href = 'send_email.php?'</script>";
                    ...
                    if ($result-> num_rows > 0){	
                        if($row = $result-> fetch_assoc()){
                            ...
                            echo "</tbody>";
                            echo "<table>";
                            echo "<h4 style='text-align:center;'>Write Your Comments</h4>";
                            echo "<textarea type='text' name='textarea' rows='5' cols='50' class='table bg-white rounded shadow-sm  table-hover'
                            style='width: 100%; margin-top: 10px; display: inline;' placeholder='Write Your Recommendations / Comments'></textarea>";

                            echo "<button type='submit' value='videoID' name='btn_accept' class='btn'  
                            style='height: 40px; border: none; width:18%; margin-right:20px;'>Approve</button>";
                            echo "<button type='submit' value='videoID' name='btn_partial' class='btn'  
                            style='height: 40px; border: none; width:18%; margin-right:20px;'>Partial</button>";
                            echo "<button type='submit' value='videoID' name='btn_deferred' class='btn'  
                            style='height: 40px; border: none; width:18%; margin-right:20px;'>Deferred</button>";
                            echo "<button type='submit' value='videoID' name='btn_reject' class='btn'  
                            style='height: 40px; border: none; width:18%; margin-right:20px;'>Reject</button>";
