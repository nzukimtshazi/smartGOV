...
?>
 ...
 <?php          
    ...
    $sql = "SELECT * FROM videos WHERE branchID='$branchID'";        $result = $conn-> query($sql);
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-3" style="width:50%;">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $user_count  ?> Videos Found</h3>
                ...
                <div class="row my-5">
                    ...
                    $count = 0; 
                    include "conn.php";
                    $sql = "SELECT * FROM videos WHERE branchID='$branchID'"; 
                    include "conn.php";
                    ...
                    if ($result-> num_rows > 0){	
                        while($row = $result-> fetch_assoc()){
                            ...
                            $description1 = "Service Date: $date \nService Time: $time \n\nService Description: $description";
                            ...
                            echo "<p class='error' style='margin-top: 10px' >No Videos Found!!!</p>";
                            echo "</div>";
                        }
                        $conn-> close();
                    ?>
