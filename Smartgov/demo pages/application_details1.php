    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <!-- ------------------------------------------------------------------------------------------ -->
                <a style="margin-top: -25px;" href="Applications1.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    ></i>Applications</a>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    if(isset($_POST['btn_accept'])){
                        ...
                        $sql_update = "UPDATE applications SET statuss = '$status', comments2 = '$comments' WHERE email = '$email' ";
                        ...
                        if ($sql_result) {	
                            ...
                            $sql5 = "SELECT * FROM login_details WHERE role='3' AND statuss='Active'";
                            ...
                            $_SESSION['email_body'] = "Dear $next_name<br><br>You have a new research funding application from $name, waiting for your approval.
                            ...
                            $_SESSION['msg3'] = "<script>location.href = 'applications1.php?'</script>";
                            echo"<script>location.href = 'send_email.php?'</script>";
                          }
                    }
                    ...
                    if(isset($_POST['btn_back'])){
                        echo"<script>location.href = 'applications1.php?'</script>";
                    }
                    ...
                    if ($result-> num_rows > 0){	
                        if($row = $result-> fetch_assoc()){
                            ...
                            echo "<textarea type='text' id='textarea' rows='30' cols='50' class='table bg-white rounded shadow-sm  table-hover'
                            ...
                            style='height: 40px; width:32%; margin-right:15px;'>Recommend</button>";
