...
<head>
    ...
    <title>Officer Upload Videos</title>
                      ...
                      <?php          
                        ...
                        if($result-> num_rows > 0){
                            // echo "<option value='0'>All Services</option>";
                                while($row = $result-> fetch_assoc()){
                                    $date = $row['date'];                  $branch_id = $row['branchID'];
                                    
                                    // RETRIEVE BRANCH ADDRESS
                                    $sql1 = "SELECT * FROM branch WHERE branchID='$branch_id'";
                                    $result1 = $conn-> query($sql1);
                                    if($result1-> num_rows > 0){
                                        while($row = $result1-> fetch_assoc()){
                                            $branchName = $row['branchName'];
                                            $mydata = $branchName." | ".$date;
                                        }
                                    }
                                        echo "<option value='$date'>$mydata</option>";
                                }
                            echo "</select>";
                        }
