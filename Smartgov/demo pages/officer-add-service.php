...
?>
<body>
<form action="check-add-service.php" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <?php          
                        ...
                        $conn-> close();
                    ?>
                    <input type="date" class="input" name="date" placeholder="Service Date" Required></input>
                    <input type="time" class="input" name="time" placeholder="Service Time" Required></input>
                    <input type="text" class="input" name="link" placeholder="Service Link" Required></input>

                    <textarea type="text" id="textarea" name="description" rows="4" cols="50" class="table bg-white rounded shadow-sm  table-hover"  
                    placeholder="Service Description" style="margin-bottom:0px; margin-top:10px;" Required></textarea>
