...
<head>
    ...
    <title>Report on Evangelism</title>
...
?>
 ...
 <?php          
    ...
    $sql = "SELECT * FROM evangelism WHERE branchID='$branchID'";        $result = $conn-> query($sql);
...
?>
<body>
    <form action="user-check-add-evangelism.php" method="post" enctypr="multipart/form-data" autocomplete="off">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-3" style="width:50%;">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $user_count  ?> Reports on Evangelism</h3>
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Report On Evangelism</h3>
                    ...
                    <textarea style="margin-top: 10px;" name="messagee" type="text" id="textarea" rows="7" cols="50" class="table bg-white rounded shadow-sm  table-hover"  
