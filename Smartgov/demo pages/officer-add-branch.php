...
?>
<body>
<form action="check-add-branch.php" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <input type="text" class="input" name="name" placeholder="Branch Name" Required></input>
                    ...
                    <input type="number" class="input" name="zipcode" placeholder="Zip Code" Required></input>
