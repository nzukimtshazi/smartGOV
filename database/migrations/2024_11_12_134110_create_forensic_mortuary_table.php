...
class CreateForensicMortuaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('forensic_mortuary')) {
            Schema::create('forensic_mortuary', function (Blueprint $table) {
                $table->id();
                $table->string('name');
            ...
            Schema::table('forensic_mortuary', function ($table) {
    ...
    {
        Schema::dropIfExists('forensic_mortuary');
    }
}
